...
func main() {
	...
	// Unlike C, Go does not use an integer return value from main to indicate exit status
	...
	// By building and executing a binary you can see the status in the terminal "echo $?"
}
