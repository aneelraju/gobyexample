...
func main() {
	// basic rate limiting. Suppose we want to limit our handling of incoming requests.
	...
	// We can accomplish this by buffering our limiter channel. This burstyLimiter channel
	// will allow bursts of upto 3 events
	...
	// Every 200ms we'll try to add a new value to burstyLimiter, upto its limit of 3
	go func() {
